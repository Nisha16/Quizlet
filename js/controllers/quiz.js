(function() {
  ...
  /*
     * Call the angular module called quizlet that was created in js/app.js
  ...
  function QuizController(quizMetrics,DataService){
    ...
    vm.error = false; // error flag. Will be set when user tries to finish quiz wit
    vm.finalize = false;// finalise flag. Will be set to show prompt to end quiz with all questions answered
    vm.finalizeAnswers = finalizeAnswers; //also a named function

    var numQuestionAnswered = 0; // This is not needed by the view so is only declared using var
